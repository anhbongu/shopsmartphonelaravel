				...
				<form id="demo-form2" action="" method="post" class="form-horizontal form-label-left" novalidate="">
					...
					<div class="item form-group">
						...
						<div class="col-md-6 col-sm-6 ">
							<input name="name" type="text" id="first-name" required="required" class="form-control " value="{{ $category->c_name }}">
						</div>
						@if($errors->has('name'))
					...
					<div class="item form-group">
						...
						<div class="col-md-6 col-sm-6 ">
							<input name="icon" type="text" id="first-name" required="required" class="form-control " value="{{ $category->c_icon }}">
						</div>
						@if($errors->has('name'))
					...
					<div class="item form-group">
						...
						<div class="col-md-6 col-sm-6 ">
							<input name="meta_title" type="text" id="first-name" required="required" class="form-control " value="{{ $category->c_title_seo }}">
						</div>
					...
					<div class="item form-group">
						...
						<div class="col-md-6 col-sm-6 ">
							<input name="meta_description" type="text" id="first-name" required="required" class="form-control " value="{{ $category->c_description_seo }}">
						</div>
